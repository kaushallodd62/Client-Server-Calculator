...
# outputSockets is a list of sockers, i.e file descriptors that are waiting to be written on. (respond data to)
outputSockets = []
        ...
        for socket in readable:
            if socket is serverSocket:
                ...
                # If expr is not empty, we evaluate the expression and add the resp to the messageQueue. We also add the socket to the outputSockets.
                    ...
                    # Echo server sends back the same message to the Client.
                    resp = expr
